...
(async function main() {
  try {
    ...
    await page.goto(
        "https://www.asmp.org/find-a-photographer/?gmw_address%5B0%5D=Oxford%2C%20UK&gmw_distance=200&gmw_faph_name&gmw_faph_sort=distance&gmw_faph_view=card&gmw_form=1&gmw_per_page=200&gmw_lat=51.7520209&gmw_lng=-1.2577263&gmw_px=pt&action=gmw_post",
      {
        waitUntil: "load",
        timeout: 0,
      }
