...
(async function main() {
  try {
    ...
    await page.goto(
        "https://www.asmp.org/find-a-photographer/?gmw_address%5B0%5D=Yosemite%20National%20Park%2C%20California%2C%20USA&gmw_distance=200&gmw_faph_name&gmw_faph_sort=distance&gmw_faph_view=card&gmw_form=1&gmw_per_page=200&gmw_lat=37.8651011&gmw_lng=-119.5383294&gmw_px=pt&action=gmw_post",
      {
        waitUntil: "load",
        timeout: 0,
      }
