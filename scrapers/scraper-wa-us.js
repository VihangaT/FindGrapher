...
(async function main() {
  try {
    ...
    await page.goto(
        "https://www.asmp.org/find-a-photographer/?gmw_address%5B0%5D=Seattle%2C%20WA%2C%20USA&gmw_distance=200&gmw_faph_name&gmw_faph_sort=distance&gmw_faph_view=card&gmw_form=1&gmw_per_page=200&gmw_lat=47.6062095&gmw_lng=-122.3320708&gmw_px=pt&action=gmw_post",
      {
        waitUntil: "load",
        timeout: 0,
      }
